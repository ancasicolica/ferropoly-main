...
<template>
  <div>
    ...
    <data-table
      ...
      <column
          field="pricelist.rents.oneHouse"
          header="Miete 1H"
      >
        <template #body="{data}">
      ...
      <column
          field="pricelist.rents.twoHouses"
          header="Miete 2H"
      >
        <template #body="{data}">
      ...
      <column
          field="pricelist.rents.threeHouses"
          header="Miete 3H"
      >
        <template #body="{data}">
      ...
      <column
          field="pricelist.rents.fourHouses"
          header="Miete 4H"
      >
        <template #body="{data}">
...
console.warn('This module is obsolete!!!');
